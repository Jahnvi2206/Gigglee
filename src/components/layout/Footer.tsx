...
export function Footer({ className }: FooterProps) {
  return (
    <footer className={cn('w-full py-16 px-6 bg-[#1f0522] text-white', className)}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-12">
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-2">
                <li>
                  <Link href="/browse-jobs" className="text-gray-300 hover:text-white">
                    Browse Jobs
                  </Link>
                </li>
                <li>
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <Link href="/inclusive-hiring" className="text-gray-300 hover:text-white">
                    Inclusive Hiring
                  </Link>
                </li>
                <li>
                  <Link href="/partner" className="text-gray-300 hover:text-white">
                    Partner With Us
                  </Link>
                </li>
              </ul>
